...
### Класс OrderModal
---
Класс управляет отображением модального окна с данными пользовтаеля - , электронная почта, телефон и способ оплаты. Расширяет класс Modal.
...
### Класс ContactsModal
---
Класс управляет отображением модального окна с данными пользователя - адрес доставки. Расширяет класс Modal.
...
### Класс SuccsessModal
---
Класс отвечает за отображение модального окна с уведомлением об успешности оформления заказа. Расширяет класс Modal.
